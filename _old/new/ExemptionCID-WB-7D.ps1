...
$DataSet.Tables[0] | select "ReservationExemptionId","IPCode","ScanDate","MRTransactionId","TransactionLineNumber","ReservationId","ReservationLineNumber","ExemptionReason","StatusCode","CreateOperatorId","CreateDate","UpdateOperatorId","UpdateDate","ResortCode" | Export-Csv $OuputFile
