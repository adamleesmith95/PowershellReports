...
$DataSet.Tables[0] | select "DC_Code", "DispCat", "DispOrder", "PHC", "PHC_DESC", "PHC_DispOrder", "Active", "Displayed", "PC_DispOrder", "Component", "PC_Desc", "SL_Code", "SaleLoc", "VrrProductId", "VrrProductDescription", "LocationCode" | Export-Csv $OuputFile
