...
$DataSet.Tables[0] | select "display_order", "DispCat", "product_header_code", "PHC", "PH_Status", "PH_Disp", "product_code", "Component", "PC_Status", "PC_Disp", "DP_Code", "DefPattern", "DefCalCode", "DefCal", "operator", "update_date" | Export-Csv -NoTypeInformation $OuputFile
