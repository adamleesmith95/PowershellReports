...
$DataSet.Tables[0] | select "Product Header Code","Product Header Description","ResortAcronym","Active","Display","DisplayOrder","Link Product Header Code","Link Product Header Description","Auto Add To Cart Ind","Default Option","Delete With Parent Only Ind" | Export-Csv -NoTypeInformation $OuputFile
