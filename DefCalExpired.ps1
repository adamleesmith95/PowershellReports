...
$DataSet.Tables[0] | select "DC_Code", "DispCat", "DC_Order", "PHC", "ProductHeader", "PH_Order", "Active", "Display", "PC", "Component", "FirsttDate", "LastDate", "DefCal", "DefCalStart", "DefCalEnd", "DC_Days", "UpdateID", "UpdateDate" | Export-Csv -NoTypeInformation $OuputFile
