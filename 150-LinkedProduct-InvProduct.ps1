...
$DataSet.Tables[0] | select "active_ind","display_ind","Product Header Code", "Product Header Description", "Link Product Header Code", "Link Product Header Description", <#"Sell Quantity", "Sell Quantity Is Quantity Ind", "Sell Quantity Is Units Ind","Auto Select Ind",#>
	"Product Link Type Code", "Product Link Type Description", "Auto Add To Cart Ind", "Default Option", <#"Display In Cart Ind", "Prompt",#> "Delete With Parent Only Ind", "Match Parent Quantity Ind" <#, "Special Logic Ind", "Display Order"#> | Export-Csv -NoTypeInformation $OuputFile
